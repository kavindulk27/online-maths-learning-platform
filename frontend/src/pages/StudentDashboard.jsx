...
const StudentDashboard = () => {
    ...
    const renderContent = () => {
        switch (activeTab) {
            case 'classes':
                return <ClassesSection paymentStatus={student.paymentStatus} />;
            case 'homework':
...
const ClassesSection = ({ paymentStatus }) => {
    const classes = [
        { id: 1, name: "Grade 11 - Theory", time: "Every Saturday 8:00 AM", zoomLink: "https://zoom.us/j/12345678" },
        { id: 2, name: "Grade 11 - Revision", time: "Every Sunday 8:00 AM", zoomLink: "https://zoom.us/j/12345678" },
    ];
        ...
        <div className="space-y-6">
            {!isApproved && (
                <div className="bg-yellow-50 border-2 border-dashed border-yellow-200 rounded-3xl p-8 flex flex-col items-center text-center">
                    ...
                    <h3 className="text-xl font-black text-gray-800 mb-2">Payment Required</h3>
                    <p className="text-gray-500 text-sm max-w-md mx-auto mb-6">
                        Zoom links will be visible once your monthly payment is approved by the teacher.
                    </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {classes.map(cls => (
                    <div key={cls.id} className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 hover:shadow-xl hover:shadow-gray-200 flex flex-col transition-all">
                        ...
                        <h3 className="text-xl font-black text-gray-800 mb-2">{cls.name}</h3>
                        ...
                        <button 
                            disabled={!isApproved}
                            className={`w-full py-4 rounded-xl font-black text-sm uppercase tracking-widest transition-all flex items-center justify-center space-x-3 ${
                                isApproved 
